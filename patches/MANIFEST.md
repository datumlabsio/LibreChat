...
Health check 2026-07-29: total diff vs v0.8.7 = +413/-3 (QA-measured at health-check commit, excl. package-lock); upstream-touched source lines ~33 vs ~250 new-file lines — metric satisfied. fork-06 dropped: v0.8.7 interface config covers all governance needs (agents/marketplace/memories/webSearch/runCode/public-shares).
